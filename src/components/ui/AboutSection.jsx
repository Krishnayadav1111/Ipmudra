        ...
        >
          ...
          >
            ...
            <Typography variant="body1" sx={{ color: '#4a4a6a', lineHeight: 1.85, mb: 3 }}>
              Our focus is excellence, our philosophy is constant vigilance, and our belief is the ethical
              exercise of the laws we are entrusted to oversee. We combine our collective experience to
              give robust legal protection to your creativity — advising individuals and corporate bodies
              in all matters of intellectual property.
            </Typography>
            <Typography variant="body1" sx={{ color: '#4a4a6a', lineHeight: 1.85, mb: 4 }}>
              The world is building in many sociological and infrastructural ways. We are here to push
              its legal growth — ensuring that innovation is rewarded, not stolen.
            </Typography>
            ...
            >
              {highlights.map((h, i) => (
                <Stack key={i} direction="row" spacing={1} alignItems="flex-start">
                  ...
                  <Typography variant="body2" sx={{ color: '#4a4a6a', fontSize: '0.88rem' }}>
                    {h}
                  </Typography>
                </Stack>
              ))}
          ...
          >
            <Box sx={{ position: 'relative', pb: { xs: 0, md: 3 } }}>
                  ...
                  {[
                    ...
                    <Box key={item.domain}>
                      <Stack direction="row" justifyContent="space-between" mb={0.8}>
                        ...
                        <Typography sx={{ color: '#C9A84C', fontSize: '0.85rem', fontWeight: 700, flexShrink: 0, ml: 1 }}>
                          {item.pct}%
                        </Typography>
                      </Stack>
                      <Box sx={{ height: 5, borderRadius: 3, background: 'rgba(255,255,255,0.1)' }}>
                        <Box
                          sx={{
                            height: '100%',
                            width: `${item.pct}%`,
              ...
              >
                ...
                <Typography sx={{ color: 'rgba(11,31,75,0.7)', fontSize: '0.75rem' }}>
